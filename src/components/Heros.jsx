...
export default function Heros({ title, description }) {
  return (
    <div className="mx-auto px-2">
      {/* Hero Section */}
      <section
        className="rounded-3xl ring-1 ring-inset ring-black/20 h-screen/2 p-4 py-12 lg:p-24 text-black relative flex flex-col justify-center items-center text-center
