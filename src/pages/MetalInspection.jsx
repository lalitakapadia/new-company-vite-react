  ...
  return (
    <>
      ...
      <div class="relative mx-auto overflow-hidden ">
        ...
        {/* 🔹 Hero Section */}
        <Heros title="Worldwide Metal Inspection & Compliance Services" description="Worldwide Quality Inspection Ltd. ensures safety, regulatory compliance, and quality assurance for metal exports across 60+ countries." />
        ...
        <main>
          ...
          <section className="m-2 py-16 px-6 lg:px-12 bg-gray-800 text-white rounded-3xl ring-1 ring-inset ring-black/20">
            <div className=" mx-auto">
              ...
              <p className="mt-4 text-lg text-center font-normal  text-gray-300">At Worldwide Quality Inspection Ltd., we follow a structured and methodical approach to ensure full compliance with international regulations and safety standards.</p>
