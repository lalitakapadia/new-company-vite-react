    ...
    <div class="mt-16 px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-7xl">
            ...
            <p class="mt-6 max-w-3xl text-2xl font-medium text-gray-500">
                We are DGFT approved Pre-shipment inspection agency authorized to conduct a metal scrap inspection.</p>
        </div>
    </div>
            ...
            <div class="mx-auto max-w-2xl lg:max-w-7xl">
                <div class="grid grid-cols-1 lg:grid-cols-[384px_1fr_1fr]">
                    <div class="-mt-96 lg:-mt-52">
                        <div
                            class="-m-2 rounded-4xl bg-white/15 shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:max-w-xs">
                    ...
                    <div class="flex lg:-mt-20 max-lg:mt-16 lg:col-span-2 lg:px-16">
