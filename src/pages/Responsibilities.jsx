...
const slides = [
  {
    ...
    description:
      "Worldwide Quality Inspection Ltd. partners with leading multinational corporations to strengthen social responsibility, ethical practices, and environmental stewardship across global supply chains.",
  },
  {
    image: ourValuesImage,
    title: "Our Values",
    description:
      "Integrity, transparency, and accountability drive every action at Worldwide Quality Inspection Ltd., ensuring sustainable growth and regulatory excellence.",
  },
  {
    image: ourApproachImage,
    title: "Our Approach",
    description:
      "At Worldwide Quality Inspection Ltd., our operations are built on trust and ethical conduct, upholding the highest professional standards in compliance and quality assurance.",
  },
  {
    image: ourImpactImage,
    title: "Our Impact",
    description:
      "Our global compliance framework reinforces ethical standards, corporate governance, and risk mitigation—supporting secure, responsible international trade.",
  },
];

const slideDuration = 4000; // in milliseconds
              ...
              <SwiperSlide key={index}>
                <div className="relative w-full h-auto sm:h-[80vh] flex flex-col sm:flex-row-reverse sm:items-center justify-right sm:pr-6">
                        ...
                        {slides.map((slide, idx) => (
                          <span
                            ...
                            className={`flex-1 text-xs font-semibold truncate ${
                              activeIndex === idx ? "text-blue-700" : "text-gray-400"
                            }`}
                          >
                            {slide.title}
                          </span>
                  ...
                  <div className="relative w-full sm:w-1/2 p-6 text-center sm:text-right text-white z-10">
                    ...
                    <p className="m-4 text-lg md:text-xl text-gray-300 font-normal hidden sm:block">
                      {slide.description}
                    </p>
                  </div>
                        ...
                        <div key={idx} className="flex-1 flex flex-col items-center">
                          <span
                            className={`text-sm font-semibold ${
                              activeIndex === idx ? "text-white opacity-100" : "text-white/60 opacity-60"
                            }`}
                          >
                            {slide.title}
                          </span>
