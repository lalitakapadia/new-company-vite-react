...
const Home = () => {
  return (
    ...
    <div class="relative px-6 lg:px-8 mt-12 pb-12 bg-gray-50">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="lg:order-1">
            <img src="./public/images/AboutHomePage.jpg" alt="About Us" class="rounded-3xl shadow-lg w-full object-cover h-80 md:h-auto" />
        </div>
        
    
        <div>
            <h2 class="font-mono text-4xl lg:text-5xl font-bold uppercase tracking-widest text-black hover:text-slate-500 mb-4">
            About Us
            </h2>
            
            <p class="mt-4 text-base md:text-lg text-gray-800 leading-relaxed">
